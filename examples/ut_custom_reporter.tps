...
-- Member functions and procedures
  ...
  overriding member procedure begin_assert(self in out nocopy ut_custom_reporter, an_assert_message in varchar2),
  overriding member procedure end_assert(self in out nocopy ut_custom_reporter, an_assert ut_assert_result),
  overriding member procedure end_test(self in out nocopy ut_custom_reporter, a_test_name in varchar2, a_test_call_params in ut_test_call_params, a_execution_result in ut_execution_result),
